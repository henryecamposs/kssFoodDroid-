...
public class ambienteDetalle_tabla {
    ...
    public ambienteDetalle_tabla(double monto, String hora, String abierta, String horaulti, String emple, String nomem, double iva, String codcli, String direccion, String nomcli, String rif, String mesa) {
        this.monto= monto;
        this.hora = hora;
